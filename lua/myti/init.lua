...
local colors = {
  ...
  selection     = "#2e2a24", -- Saturated warm sand selection block
  border        = "#443e38", -- Earthy clay structural divider line
  fg            = "#bebdc9", -- Rich cream warm text primary
  gray          = "#806669", -- Textured wood gray for comments
...
-- -- Zenbones x Rosé Pine (Muted Warm Base with a Tiny Bright Lift)
   terracotta    = "#92777a", -- Barely brightened rose-ash clay (Statements, Errors, Keywords)
   forest_green  = "#9d8e7c", -- Tiny lift dry pine green / olive (Strings)
   sand_gold     = "#bca39c", -- Softly lit milk-honey gold (Functions, Labels)
   sky_teal      = "#7f9091", -- Slightly glowing slate pine teal (Types, Structure Tags)
   blossom_rose  = "#c39da7", -- Tiny pop of dusty chalky rose (Constants, Numbers)
   clay_orange   = "#c6a993", -- Softly illuminated sun-bleached orange (Specials, Identifiers)
   water_blue    = "#90889b", -- Barely brightened lavender-tinted blue (Parameters, Attributes)
 --
